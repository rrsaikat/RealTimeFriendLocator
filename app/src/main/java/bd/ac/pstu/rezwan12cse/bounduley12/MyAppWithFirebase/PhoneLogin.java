...
public class PhoneLogin extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mVerifyViews = (ViewGroup) findViewById(R.id.verify_fields);
        mDetailText = (TextView) findViewById(R.id.detail);
        mPhoneNumberField = (EditText) findViewById(R.id.field_phone_number);
        mVerificationField = (EditText) findViewById(R.id.field_verification_code);
        t1 = (EditText)findViewById(R.id.edittext_one);
        t2 = (EditText)findViewById(R.id.edittext_two);
        t3 = (EditText)findViewById(R.id.edittext_three);
        t4 = (EditText)findViewById(R.id.edittext_four);
        t5 = (EditText)findViewById(R.id.edittext_five);
        t6 = (EditText)findViewById(R.id.edittext_six);
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(FirebaseException e) {
                ...
                if (e instanceof FirebaseAuthInvalidCredentialsException) {
                    ...
                    // [START_EXCLUDE]
                    Snackbar.make(findViewById(android.R.id.content), "1000 Quota completed! Can't Login anymore in this month!",
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            startActivity(new Intent(PhoneLogin.this, UserRegister.class));
                            finish();
    ...
    private void updateUI(int uiState, FirebaseUser user, PhoneAuthCredential cred) {
      ...
      /*                  t1.setText(cred.getSmsCode().charAt(0));
                        t2.setText(cred.getSmsCode().charAt(1));
                        t3.setText(cred.getSmsCode().charAt(2));
                        t4.setText(cred.getSmsCode().charAt(3));
                        t5.setText(cred.getSmsCode().charAt(4));
                        t6.setText(cred.getSmsCode().charAt(5));
      */
                    } else {
